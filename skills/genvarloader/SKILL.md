...
- `unphased_union=True` + `with_seqs("haplotypes" | "annotated")` raises — `unphased_union` only applies to `"variants"` / `"variant-windows"` output.
