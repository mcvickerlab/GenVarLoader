...
from genvarloader.gloader import GenomeLoader
from genvarloader.gloader.consensus import ConsensusGenomeLoader
from genvarloader.utils import IndexType, PathType, read_bed
